...
const impact = new Impact("Test Impact", (Math.PI/6)*Math.pow(impactorDiameter/2,3)*impactorDensity*4, impactorDensity, impactorSpeed, impactAngle, {lamb: impactorLongitude, phi: impactorLatitude});
