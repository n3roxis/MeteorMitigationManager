...
function createInboundMeteor400d(): Meteor {
  const flightDays = 360; // Adjust this to change time-of-flight
  ...
  const m = new Meteor('meteor_uno', start.x, start.y, start.z, vStart.x, vStart.y, vStart.z, 5e12, 0xc0c0c0, tof);
  return m;
}
